...
csv_path = "/data/kjh/save_log/imagenet_resnet50im/log_imagenet_resnet50im_bs128_ep200_seed_3/csv/"
def main():
    ...
    for epoch in range(start_epoch, option.epochs):
        ...
        if epoch in option.activation_step:
            ...
            for hook in result_fwd_hook_list:
                ...
                #save_input_pkl_path = os.path.join(option.save_path, f"{name}_{epoch}_fwd_input.pkl")
